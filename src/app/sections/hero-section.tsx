    ...
    return (
        <div>
            <div className="her-image flex justify-center items-center">
                {/* <Image
                    className=" rounded-full size-56 border-4 dark:border-slate-200 border-slate-300"
                    alt="hero image"
                    src={`/profile/profile.jpg`}
                    width={100}
                    height={100}
                ></Image> */}
                <div className="relative size-56 rounded-full border-4 dark:border-slate-200 border-slate-300 overflow-hidden">
                    <Image
                        src={`/profile/profile.jpg`}
                        fill
                        alt="hero image"
            ...
            <div className="hero-text mt-4 text-center">
                <div className="flex gap-3 justify-center">
                    ...
                    <h1 className="font-bold text-3xl mb-7 dark:text-white">
                        I&apos;m Godwin
                    </h1>
                </div>
            ...
            <div className="her-actions flex items-center justify-center gap-4 mt-7">
                ...
                <Link href={`mailto:anadudev@gmail.com`}>
                    <Button
                        ...
                        shine={true}
                        type="buttonPrimary"
                        style="px-3 py-2 dark:bg-white bg-primary before:bg-gradient-to-r from-primary dark:from-white rounded-lg hover:drop-shadow-xl transition-all eas-in-out"
                        shadow={true}
                    />
                </Link>
            </div>
